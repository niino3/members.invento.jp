              ...
              {dateRange.start && (
                <button
                  ...
                  onClick={() => {
                    ...
                    setFilters(prev => { const f = { ...prev }; delete f.startDate; return f; });
                  }}
              ...
              {dateRange.end && (
                <button
                  ...
                  onClick={() => {
                    ...
                    setFilters(prev => { const f = { ...prev }; delete f.endDate; return f; });
                  }}
                  className="px-2 text-gray-400 hover:text-gray-600"
                >
                  ✕
          ...
          {(dateRange.start || dateRange.end) && (
            <button
              onClick={() => {
                ...
                setFilters(prev => { const f = { ...prev }; delete f.startDate; delete f.endDate; return f; });
              }}
